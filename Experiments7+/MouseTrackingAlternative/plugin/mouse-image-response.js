    ...
    class MouseImageResponse {
        ...
        trial(display_element, trial) {
            ...
            let start_trial = function() {
                ...
                draw();
                // end trial if trial_duration is set, start timer only after trial is started
                if (trial.trial_duration !== null) {
                    _self.jsPsych.pluginAPI.setTimeout(end_trial, trial.trial_duration);
                }
            };
            ...
            let end_trial = () => {
                ...
                if (trial.trial_duration !== null && end_rt >= trial.trial_duration) {
                    end_loc = null;
                }
